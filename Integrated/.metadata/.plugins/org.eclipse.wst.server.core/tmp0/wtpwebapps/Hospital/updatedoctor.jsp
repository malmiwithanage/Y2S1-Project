...
<body>
	...
	<form action="UpdateDoctorServlet" method="post">
		...
		<table>
			<tr>
				<td>Doctor ID</td>
				<td><input type="text" name="docid" value="<%=id%>" readonly><br>
				</td>
			</tr>
			<tr>
				<td>Name</td>
			...
			<tr>
				<td>Phone number</td>
				<td><input type="text" name="phone" value="<%=phone%>"><br>
				</td>
			</tr>
			<tr>
				<td>User name</td>
				<td><input type="text" name="uname" value="<%=userName%>"><br>
				</td>
			</tr>
			<tr>
				<td>Password</td>
				<td><input type="password" name="pass" value="<%=password%>"><br>
				</td>
			</tr>
			<tr>
				<td>Department</td>
				<td><input type="text" name="department"
					value="<%=department%>"><br></td>
			</tr>
			<tr>
				<td>Gender</td>
				<td><input type="text" name="gender" value="<%=gender%>"><br>
				</td>
			</tr>
			<tr>
				<td>Speciality</td>
				<td><input type="text" name="speciality"
					value="<%=speciality%>"><br></td>
			</tr>
			<tr>
				<td>License Number</td>
				<td><input type="text" name="licencenumber"
					value="<%=licencenumber%>"><br></td>
			</tr>
			<tr>
				<td>Address</td>
				<td><input type="text" name="address" value="<%=address%>"><br>
				</td>
			</tr>
			<tr>
				<td>Shift</td>
				<td><input type="text" name="shift" value="<%=shift%>"><br>
				</td>
			</tr>
			<tr>
				<td>Appointment Fee</td>
				<td><input type="text" name="appointmentfee"
					value="<%=appointmentfee%>"><br></td>
			</tr>
			<tr>
				<td>Consultation Room</td>
				<td><input type="text" name="consultationroom"
					value="<%=consultationroom%>"><br></td>
			</tr>
		</table>
