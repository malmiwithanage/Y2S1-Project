...
<table>
    ...
    <tr>
        <td>Speciality</td>
        <td>
            <input type="text" name="speciality" value="<%= speciality %>"><br>
        </td>
    </tr>
    <tr>
        <td>License Number</td>
        <td>
            <input type="text" name="licencenumber" value="<%= licencenumber %>"><br>
        </td>
    </tr>
    <tr>
        <td>Address</td>
    ...
    <tr>
        <td>Shift</td>
        <td>
            <input type="text" name="shift" value="<%= shift %>"><br>
        </td>
    </tr>
    <tr>
        <td>Appointment Fee</td>
        <td>
            <input type="text" name="appointmentfee" value="<%= appointmentfee %>"><br>
        </td>
    </tr>
    <tr>
        <td>Consultation Room</td>
        <td>
            <input type="text" name="consultationroom" value="<%= consultationroom %>"><br>
        </td>
    </tr>
</table>
